...
- [Converge is hiring!](https://discourse.haskell.org/t/converge-is-hiring/13593) by Gideon Farrell
...
- [Announcing Aztecs v0.17: OpenGL rendering and more engine features](https://discourse.haskell.org/t/announcing-aztecs-v0-17-opengl-rendering-and-more-engine-features/13608) by Matt Hunzinger
...
- [HaskellSpace - A Haskell workspace in your browser (GHC + Stack + HLS)](https://www.reddit.com/r/haskell/comments/1qlqec6/ann_haskellspace_a_haskell_workspace_in_your/) by LCamel
  > I created a ready-to-use Haskell environment on GitHub Codespaces.
  
- [postgresql-types](https://github.com/nikita-volkov/postgresql-types) by Nikita Volkov
  > Precise Haskell representations of PostgreSQL data types with mappings to and from both binary and textual formats.
  
- [Yank](https://github.com/HosseinAbedi/Yank) by Hossein Abedi
  > A simple, fast downloader with resume and progress. Use the standalone binary or Docker - no Haskell setup required.
  
## Show & tell

- [Dynamic GHC matrix in GitHub CI](https://hasufell.github.io/posts/2026-01-22-dynamic-ghcup-action.html) by Julian Ospald
...
- [GSoC 2026: Final call for ideas](https://www.reddit.com/r/haskell/comments/1qq0eqv/gsoc_2026_final_call_for_ideas/) by Aaron Allen
...
- [Improving Machine Arithmetic](https://discourse.haskell.org/t/improving-machine-arithmetic/13602) by mniip
  > I would like to invite some discussion about this topic, what such a package could look like, what changes `base` could look like, etc.

- [RFC: New major version of `yesod-core`](https://discourse.haskell.org/t/rfc-new-major-version-of-yesod-core/13592) by Matt Parsons
...
- [swarm: Move `Swarm.Language.*` modules out of `swarm-util`](https://github.com/swarm-game/swarm/issues/2677)
