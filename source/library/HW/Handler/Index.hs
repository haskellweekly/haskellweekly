...
stateContents :: HW.Type.State.State -> [HW.Type.Content.Content]
stateContents state =
  let
...
sortContents :: [HW.Type.Content.Content] -> [HW.Type.Content.Content]
sortContents = Data.List.sortOn $ Data.Ord.Down . contentDate

contentDate :: HW.Type.Content.Content -> HW.Type.Date.Date
contentDate content = case content of
  HW.Type.Content.ContentEpisode episode ->
    HW.Type.Episode.episodeDate episode
  HW.Type.Content.ContentIssue issue -> HW.Type.Issue.issueDate issue
