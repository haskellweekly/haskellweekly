...
template baseUrl =
  Base.template baseUrl "2022 Survey :: Haskell Weekly" mempty $ do
    ...
    H.div_ $ do
      H.p_ $ do
        "Welcome to the 2022 State of Haskell Survey! "
...
haskellUsageSection =
  makeSection
    ...
    [ Question "What is your email address?" Email,
      ...
      Question "If you stopped using Haskell, how long did you use it before you stopped?" $
        SingleResponse
          [ "Less than 1 day",
            "1 day to 1 week",
            "1 week to 1 month",
      ...
      Question "If you do not use Haskell, why not?" $
        MultiResponse
          AllowOther
      ...
      Question "How many years have you been using Haskell?" $
        SingleResponse
          [ "Less than 1",
            "1 to 2",
            "2 to 3",
      ...
      Question "Do you use Haskell at work?" $
        SingleResponse
      ...
      Question "If you do not use Haskell at work, why not?" $
        MultiResponse
          AllowOther
          [ "Haskell does not support the platforms I need",
            "Haskell is too hard to learn",
      ...
      Question "Which programming languages other than Haskell are you fluent in?" $
        MultiResponse
          AllowOther
          [ "Assembly",
            "C",
      ...
      Question "Which industries do you use Haskell in?" $
        MultiResponse
          AllowOther
          [ "Academia",
            "Banking or finance",
...
projectsSection =
  makeSection
    "Projects"
    [ Question "How many Haskell projects do you contribute to?" $
        SingleResponse
          [ "0",
            "1",
            "2",
      ...
      Question "What is the total size of all the Haskell projects you contribute to?" $
        SingleResponse
      ...
      Question "Which platforms do you target?" $
        MultiResponse
          AllowOther
          [ "Android",
            "BSD",
...
compilersSection =
  makeSection
    ...
    [ Question "Which Haskell compilers do you use?" $
      ...
      Question "Has upgrading your Haskell compiler broken your code in the last year?" $
        SingleResponse
          [ "Yes",
            "No"
          ],
      Question "How has upgrading your Haskell compiler broken your code in the last year?" $
        MultiResponse
          AllowOther
          [ "Compiler bugs",
      ...
      Question "How important do you feel it would be to have a new version of the Haskell language standard?" $
        SingleResponse
          [ "Extremely important",
            "Very important",
...
toolingSection =
  makeSection
    "Tooling"
    [ Question "Which build tools do you use for Haskell?" $
        MultiResponse
          AllowOther
          [ "Bazel",
            "Cabal",
      ...
      Question "Which editors do you use for Haskell?" $
        MultiResponse
          AllowOther
          [ "Atom",
            "Emacs family",
      ...
      Question "Which IDEs do you use for Haskell?" $
        MultiResponse
          AllowOther
          [ "IntelliJ",
            "Intero",
      ...
      Question "Which tools do you use to test Haskell code?" $
        MultiResponse
          AllowOther
...
infrastructureSection =
  makeSection
    ...
    [ Question "Which tools do you use to deploy Haskell applications?" $
      ...
      Question "Where do you deploy Haskell applications?" $
        MultiResponse
          AllowOther
          [ "Amazon Web Services",
            "Digital Ocean",
...
communitySection =
  makeSection
    ...
    [ Question "Where do you interact with the Haskell community?" $
      ...
      Question "Which of the following Haskell topics would you like to see more written about?" $
        MultiResponse
          AllowOther
...
demographicsSection =
  makeSection
    ...
    [ Question "Which country do you live in?" $
      ...
      Question "Do you consider yourself a member of an underrepresented or marginalized group in technology?" $
        MultiResponse
          AllowOther
      ...
      Question "Do you feel your belonging to an underrepresented or marginalized group in technology makes it difficult for you to participate in the Haskell community?" $
        SingleResponse
          [ "Often",
            "Sometimes",
            "Never"
      ...
      Question "How large is the company you work for?" $
        SingleResponse
      ...
      Question "Do you code as a hobby?" $
        SingleResponse
          [ "Yes",
            "No"
          ],
